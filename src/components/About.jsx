        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              I'm an enthusiastic IT undergraduate with a strong foundation in Artificial Intelligence, Data Analytics, and Full-Stack Web Development. My toolkit spans Python, Java, Spring Boot, AWS, and Tableau—building scalable, data-driven solutions. I've completed virtual internships with J.P. Morgan, Tata Group, Deloitte, and AWS, and competed at IIT tech events including IIT Bombay and IIT Kharagpur.
            </p>
          </div>
          ...
          <div className="overflow-hidden mt-6">
            <blockquote className="stagger-reveal border-l-2 border-red-500/50 pl-6 py-2">
              <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
                “Continuous learning fuels innovation— <br /> every challenge is a chance to grow.”
              </p>
            </blockquote>
          </div>
