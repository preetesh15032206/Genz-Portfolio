      ...
      <div className="max-w-2xl w-full relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-12 animate-element">
          ...
          <p className="text-gray-400 font-light text-lg tracking-wide leading-relaxed max-w-xl mx-auto">
            Have a project idea, internship opportunity, or just want to talk tech? My inbox is always open—let’s build something meaningful together.
          </p>

          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-xl mx-auto">
            <div>
              <p className="text-xs uppercase tracking-widest text-red-400 mb-1">Email</p>
              <a href="mailto:preetesh4153@gmail.com" className="text-gray-200 text-sm hover:text-white break-all">preetesh4153@gmail.com</a>
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-red-400 mb-1">Phone</p>
              <a href="tel:+919372874710" className="text-gray-200 text-sm hover:text-white">+91 93728 74710</a>
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-red-400 mb-1">Location</p>
