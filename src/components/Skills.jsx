...
const SKILLS = [
  ...
  { name: 'Java', level: 'Object-oriented programming and backend logic' },
  { name: 'Spring Boot', level: 'Intermediate — API development and microservices' },
  { name: 'AWS', level: 'Hands-on with EC2, S3, and Lambda' },
  { name: 'Tableau', level: 'Data visualization and dashboard creation' },
  { name: 'JavaScript', level: 'Advanced — dynamic web functionality and DOM' },
  { name: 'Tailwind CSS', level: 'Responsive, modern UI design' },
